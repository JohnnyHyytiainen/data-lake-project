# run_pipeline script - Egna CLI commands med ARGPARSE
# Kommentarer: Svenska
# Kod: Engelska
import argparse
import sys
...
# ========== Layer funktioner ==========
# Varje funktion importerar och kör sitt eget transform script.
# Importerar inne i funktionerna (Lazy imports) istället för på top level.
# Läs file_docs för förklaring.


# Köra bronze till silver layer
def run_bronze() -> None:
...
# Köra ALLTING bronze -> gold layer
def run_all() -> None:
    """
...
if __name__ == "__main__":
    ...
    if args.layer == "bronze":
        ...
        sys.exit(1)
# Sista Else keyword/statement kan egentligen aldrig inträffa eftersom argparse validerar choices innan jag når dit.
# Men det är en bra vana att alltid ha ett explicit else keyword/statement som fångar edge cases/oväntade fall.
